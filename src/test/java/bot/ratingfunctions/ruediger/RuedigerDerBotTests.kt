...
class RuedigerDerBotTests {
    ...
    fun testProgressed() {
        ...
        assertEquals(3, ruedigerDerBot.cachedLastOwnThreadMap[1][1])
        assertEquals(3, ruedigerDerBot.cachedLastOwnThreadMap[4][1])
        assertEquals(3, ruedigerDerBot.cachedLastOwnThreadMap[4][3])
        assertEquals(3, ruedigerDerBot.cachedLastOppThreadMap[1][1])
        assertEquals(3, ruedigerDerBot.cachedLastOppThreadMap[1][2])
        assertEquals(3, ruedigerDerBot.cachedLastOppThreadMap[1][3])
        assertEquals(3, ruedigerDerBot.cachedLastOppThreadMap[4][3])
        assertEquals(3, ruedigerDerBot.cachedLastOppThreadMap[4][4])
        ...
        println(print(ruedigerDerBot.cachedLastOwnThreadMap))
        println(print(ruedigerDerBot.cachedLastOppThreadMap))
    }
